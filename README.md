...
**This is a fork of Yup designed specifically for conversion to Swagger Definitions. It aims to stay current with the upstream but adds some features that the author of Yup has not merged.**
